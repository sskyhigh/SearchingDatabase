...
public class _EmployeeD {
    ...
    public void updateEmployee(Employee employee) throws SQLException {
        ...
        PreparedStatement Statement = null;
        try {
            Statement = connection.prepareStatement("update employees" + " set first_name=?, " +
                    "last_name=?, email=?, salary=?" + " where id=?");
    ...
    public void addEmployee(Employee employee) throws Exception {
        PreparedStatement statement = null;
        try {
            statement = connection.prepareStatement("insert into employees" + "(first_name, " +
                    "last_name, email, salary)" + "values (?, ?, ?, ?)");
            statement.setString(1, employee.getFirstName());
            statement.setString(2, employee.getLastName());
            statement.setString(3, employee.getEmail());
            statement.setBigDecimal(4, employee.getSalary());
    ...
    public List<Employee> searchEmployees(String lastName) throws Exception {
        ...
        try {
            ...
            statement = connection.prepareStatement("select * from employees where last_name " +
                    "like" + " ?");
        ...
        } finally {close(statement, resultSet);}
        return list;
    }
}
